...
public enum L10n {
    ...
    private static let en: [String: String] = [
        ...
        "menu.notSelected": "(not selected — dictatorctl provider use <name>)",
        "menu.logs": "Logs",
        ...
        "error.accessibilityRequired": "Accessibility must be enabled — system panel opened",
        ...
        // status.*
        "status.title": "AltDictation — status",
        ...
        // ── CLI + Batch (dictatorctl) ──
        "usage.title":        "Usage: dictatorctl <command> [args]",
        "usage.cmds":         "Commands:",
        ...
        "usage.config.setkey":"Write api_key to [providers.PROVIDER] section (chmod 600; key not specified — keyboard input or stdin with --stdin/--pipe; DICTATION_API_KEY warning)",
        ...
        "cli.plist.notfound": "Plist template dictation-agent.plist.template not found (check Resources next to binary or in project; or set DICTATION_PLIST_TEMPLATE)",
        "cli.agent.notfound": "Failed to locate DictatorAgent path",
        ...
        "cli.no.active":      "(not selected — `dictatorctl provider use <name>`)",
        "cli.config.hint":    "Config not found — create template: `dictatorctl config init`",
        "cli.pid.none":       "none",
        "cli.config.overwrite":  "Config %@ exists. Overwrite? (y/N)",
        "cli.config.exists":     "Config already exists: %@",
        "cli.config.forcehint":  "Use `dictatorctl config init --force` to overwrite.",
        "cli.config.writeerror": "ERROR: failed to write %@: %@",
        "cli.config.template":   "Config template created: %@ (chmod 600)",
        "cli.config.fillserts":  "Fill secrets: `dictatorctl config set-key <provider>` or edit the file.",
        "cli.config.noread":     "Failed to read config: %@",
        "cli.config.missing":    "Config not found: create template with `dictatorctl config init` (%@)",
        "cli.config.noset":      "(not selected)",
        "cli.setkey.usage":    "Usage: dictatorctl config set-key <provider-id> [key] [--stdin]",
        ...
        "cli.setkey.envwarn":  "WARNING: DICTATION_API_KEY env var is set — it takes priority over file api_key;",
        "cli.setkey.envnote":  "the written key will not be used while it is set (see `dictatorctl config show`).",
        ...
        "cli.provider.kickfail": "Agent not restarted (run `dictatorctl start`): %@",
        "cli.routing.usage":    "Usage: dictatorctl routing set segment|final <provider-id> [--no-restart]",
        "cli.routing.unset.usage": "Usage: dictatorctl routing unset segment|final [--no-restart]",
        ...
        "cli.routing.main.usage":"Usage: dictatorctl routing [show]|set|unset",
        "cli.transcribe.usage": "Usage: dictatorctl transcribe FILE [--json]",
        "cli.transcribe.nofile": "Usage: dictatorctl transcribe FILE [--json]",
        ...
        "cli.retry.usage":       "Usage: dictatorctl retry NAME",
        "cli.retry.available":   "Available providers: %@",
        "cli.retry.notrunning":  "ERROR: agent not running — last WAV is held in agent memory. Start the agent (`dictatorctl start`) and retry.",
        "cli.retry.sent":        "Retry sent to agent: re-transcribing last recording with provider '%@ [%@]'",
        "cli.logs.notfound":     "Log not found",
        "cli.help.usage":        "Usage: dictatorctl <command> [args]",
        ...
        "cli.routing.listHint":      "List: `dictatorctl provider list`",
    ...
    private static let ru: [String: String] = [
        ...
        "menu.notSelected": "(не выбран — `dictatorctl provider use <имя>`)",
        "menu.logs": "Логи",
        ...
        "error.accessibilityRequired": "Необходимо разрешить доступность для клавиатуры — системная панель открыта",
        ...
        // status.*
        "status.title": "AltDictation — статус",
        ...
        // ── CLI + Batch (dictatorctl) ──
        "usage.title":        "Использование: dictatorctl <команда> [аргументы]",
        "usage.cmds":         "Команды:",
        ...
        "usage.config.setkey":"Записать api_key в секцию [providers.ПРОВАЙДЕР] (chmod 600; КЛЮЧ не указан — ввод с клавиатуры или stdin при --stdin/пайпе; предупреждение, если задан DICTATION_API_KEY)",
        ...
        "cli.plist.notfound": "Не найден шаблон dictation-agent.plist.template (проверьте Resources рядом с бинарником или в проекте; или задайте DICTATION_PLIST_TEMPLATE)",
        "cli.agent.notfound": "Не удалось определить путь к DictatorAgent",
        ...
        "cli.no.active":      "(не выбран — `dictatorctl provider use <имя>`)",
        "cli.config.hint":    "Конфиг не найден: создайте шаблон — `dictatorctl config init`",
        "cli.pid.none":       "нет",
        "cli.config.overwrite":  "Конфиг %@ уже существует. Перезаписать? (y/N)",
        "cli.config.exists":     "Конфиг уже существует: %@",
        "cli.config.forcehint":  "Для перезаписи используйте `dictatorctl config init --force`.",
        "cli.config.writeerror": "ОШИБКА: не удалось записать %@: %@",
        "cli.config.template":   "Шаблон конфига создан: %@ (chmod 600)",
        "cli.config.fillserts":  "Заполните секреты: `dictatorctl config set-key <provider>` или отредактируйте файл.",
        "cli.config.noread":     "Не удалось прочитать конфиг: %@",
        "cli.config.missing":    "Конфиг не найден: создайте шаблон — `dictatorctl config init` (%@)",
        "cli.config.noset":      "(не выбран)",
        "cli.setkey.usage":    "Использование: dictatorctl config set-key <provider-id> [ключ] [--stdin]",
        ...
        "cli.setkey.envwarn":  "ПРЕДУПРЕЖДЕНИЕ: задана переменная окружения DICTATION_API_KEY — она имеет приоритет над файловым api_key;",
        "cli.setkey.envnote":  "записанный ключ не будет использоваться, пока задана переменная (см. `dictatorctl config show`).",
        ...
        "cli.provider.kickfail": "Агент не перезапущен (запустите `dictatorctl start`): %@",
        "cli.routing.usage":    "Использование: dictatorctl routing set segment|final <provider-id> [--no-restart]",
        "cli.routing.unset.usage": "Использование: dictatorctl routing unset segment|final [--no-restart]",
        ...
        "cli.routing.main.usage":"Использование: dictatorctl routing [show]|set|unset",
        "cli.transcribe.usage": "Использование: dictatorctl transcribe ФАЙЛ [--json]",
        "cli.transcribe.nofile": "Использование: dictatorctl transcribe ФАЙЛ [--json]",
        ...
        "cli.retry.usage":       "Использование: dictatorctl retry ИМЯ",
        "cli.retry.available":   "Доступные провайдеры: %@",
        "cli.retry.notrunning":  "ОШИБКА: агент не запущен — последний WAV хранится в памяти агента. Запустите агент (`dictatorctl start`) и повторите.",
        ...
        "cli.help.usage":        "Использование: dictatorctl <команда> [аргументы]",
        ...
        "cli.routing.listHint":      "Список: `dictatorctl provider list`",
