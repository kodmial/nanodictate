...
final class ProviderTests: XCTestCase {
    ...
    @objc func testParseTwoProviders() throws {
        ...
        model = "gigaam-v3"
        api_key_file = "~/.config/nanodictate/keys/gigaam.key"
        """
        ...
        XCTAssertEqual(gigaam.apiKeyFile, "~/.config/nanodictate/keys/gigaam.key")
    ...
    @objc func testLoadExpandsTildeInApiKeyFile() throws {
        ...
        let keyPath = "\(home)/.nanodictate_test_key_\(UUID().uuidString).key"
